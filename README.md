...
```txt
> whoami
Marketing nerd, dealmaker em treinamento, aluno eterno de IA aplicada a negócios.
```
...
1. Troque "SEU_USUARIO" no contador de visitas pelo seu usuário real do GitHub.
